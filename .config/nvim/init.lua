...
--  Schedule the setting after `UiEnter` because it can increase startup-time.https://chatgpt.com/
...
vim.keymap.set('n', '<C-l>', '<cmd>echo "Use l to move!!"<CR>')
...
require('lazy').setup({
  ...
  opts = {
    ...
    mappings = {
      add = 'ys', -- Now you can use 'ys' (Yank-Surround)
      delete = 'ds', -- Now you can use 'ds' (Delete-Surround)
      replace = 'cs', -- Now you can use 'cs' (Change-Surround)
    },
  },
  --
